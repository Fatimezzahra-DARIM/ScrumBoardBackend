	...
	<div id="app" class="app-without-sidebar">
		...
		<div id="content" class="app-content main-style">
			<div class="navbar">
				...
				<div class="">
					<button type="button" class="btn high text-white p-2 rounded-4" style="background-color: #5d3c3c;" data-toggle="modal" data-target="#exampleModal"><i class="bi bi-plus"></i> Add Task</button>

					<!-- ADD TASK MODAL -->
					<div class="modal fade shadow-sm" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								<div class="modal-header" style="background-color: #5d3c3c;">
									...
									<button type="button" class="close text-light-200 border-0 fs-4 " style="background-color: #5d3c3c;" data-dismiss="modal" aria-label="Close">
								...
								<div class="modal-body " style="background-color:buttonface">
									<form method="POST" action="scripts.php" class="d-block fw-bold" id="formTask">
										...
										<input class="form-control input-sm m-1  shadow-sm" type="text" name="titre" id="titre" required>
										</br>
										<label for="type" class="d-block">Type:</label>
										<div class="form-check">
											<input class="form-check-input mx-2  shadow-sm" type="radio" name="type" id="idBug" value="1">
											<label class="form-check-label">Bug</label>
										</div>
										<div class="form-check">
											<input class="form-check-input mx-2  shadow-sm" type="radio" name="type" id="idFeature" value="2">
											<label class="form-check-label">Feature</label>
										</div>
										</br>
										<label for="propriete" class="d-block">Propriete:</label>
										<select class="form-select form-select-sm m-1 shadow-sm" name="propriete" id="propriete">
										...
										<select class="form-select form-select-sm m-1 shadow-sm" name="status" id="status" required>
											<option value="" selected>----Please Select----</option>
										...
										<input class="form-control input-sm m-1 shadow-sm" type="date" name="date" id="date">
										</br>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class=" ">
						<div class="card-header " style="background-color: #5d3c3c;">
							<h4 class="text-center fw-bolder pt-1 text-light">To do (<span id="to-do-tasks-count"><?php countTasks(1) ?></span>)</h4>
						...
						<div class="" id="to-do-tasks">
							...
							?>
									<button class="container-fluid d-flex my-1 border-0 rounded p-2">
										<div class="col-1">
										...
										<div class="col-11">
											...
											<div class="">
												<div class="text-muted">#<?= $GLOBALS['tasks'][$i]['id'] ?> Created in :<?= $GLOBALS['tasks'][$i]['task_datetime'] ?>
													<div class="" title="<?= $GLOBALS['tasks'][$i]['description'] ?>"> <?= $GLOBALS['tasks'][$i]['description'] ?></div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="">
						<div class="card-header" style="background-color: #5d3c3c;">
							<h4 class="text-center fw-bolder pt-1 text-light">In Progress (<span id="in-progress-tasks-count"><?php countTasks(2) ?></span>)</h4>
				...
				<div class="col-lg-4 col-md-6">
					<div class="">
						<div class="card-header" style="background-color: #5d3c3c;">
							<h4 class="text-center fw-bolder pt-1 text-light">Done (<span id="done-tasks-count"><?php countTasks(3) ?></span>)</h4>
						...
						<div class=" " id="done-tasks">
							...
							?>
									<button method="POST" class="container-fluid d-flex my-1 border-0 rounded p-2">
										<div class="col-1">
